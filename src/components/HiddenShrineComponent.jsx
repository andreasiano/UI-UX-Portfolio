...
import shrineImage6 from "../assets/HiddenShrineImg6.png";
...
const HiddenShrineComponent = () => {
  return (
    ...
    >
      ...
      <div className="h-64 md:h-80 lg:h-96 lg: mt-[30px] lg:mb-[50px]"></div>
      <div className="text-center">
        ...
        <div className="w-full max-w-5xl mt-4 mb-4 flex flex-col items-center">
          <img
            src={shrineImage5}
